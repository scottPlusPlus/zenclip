...
import zenclip.Timeline.Marker;
import utest.ITest;
import utest.Assert;
import zenclip.*;
import test.TestClock;

class TimelineTest extends utest.Test {
    ...
    function testTimeline(){
        ...
        var markers = new Array<Timeline.Marker>();
        ...
        var timeline = new Timeline(testClock.signalDelta.asSignal(), markers);
        timeline.play();
